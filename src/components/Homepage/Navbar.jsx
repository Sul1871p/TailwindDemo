        ...
        >
          <div className="flex flex-col h-full p-4">
            ...
            <div className="flex flex-col space-y-6 mt-8">
              <a 
                href="#home" 
                className="text-gray-700 text-xl hover:text-red-600 transition"
                onClick={toggleSidebar}
              >
                Home
              </a>
              ...
              <a 
                href="#reserve" 
                className="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition text-center mt-4"
                onClick={toggleSidebar}
              >
                Reserve Now
              </a>
